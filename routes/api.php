...
Route::post('create-payment', function (Request $request) {
    ...
    $apiContext = new \PayPal\Rest\ApiContext(
        new \PayPal\Auth\OAuthTokenCredential(
            'AY-zgpaSUVZUMBpkly0pgaGIIt7rHeCHhOL1Ym4pDSpMzVO3ZZDi6bH1ZGWNtD8uv5-BS2sjeIPWPdP5',     // ClientID
            'EC0MAOmU_mGkkjWNY3535esTutMtM3CeGLcfXQPBV2afiupVdJgc4h8Zbsd-YnjsWY8SKRLJf_2c6LvD'      // ClientSecret
        )
        );
    $payer = new Payer();
